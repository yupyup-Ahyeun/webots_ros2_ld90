...
data_files.append(('share/' + package_name + '/protos/meshes', ['protos/meshes/camera_bracket.dae']))
data_files.append(('share/' + package_name + '/protos/meshes', ['protos/meshes/oakd_pro.dae']))
